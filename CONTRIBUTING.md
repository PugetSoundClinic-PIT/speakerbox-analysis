...
Ready to contribute? Here's how to set up `speakerbox-analysis` for local development.

1. Fork the `speakerbox-analysis` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/speakerbox-analysis.git
    ```

3. Install the project in editable mode. (It is also recommended to work in a virtualenv or anaconda environment):

    ```bash
    cd speakerbox-analysis/
    just install
    ```

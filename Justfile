...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=speakerbox_analysis speakerbox_analysis/tests
...
generate-docs:
	rm -f docs/speakerbox_analysis*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs speakerbox_analysis **/tests
